...
export class Sidebar {
    menuItems: MenuItem[] = [
        new MenuItem("Dashboard2", "dashboard", "/dashboard/home"),
        new MenuItem("Register", "dashboard", "/dashboard/home/Register"),
        new MenuItem("Driver Details", "dashboard", "/dashboard/Driver"),
      new MenuItem("Payment Details", "dashboard", "/dashboard/home/Payment_Details"),
